...
fm4_to_mevfm3 = ħc
mevfm3_to_fm4 = fm4_to_mevfm3^(-1)
fm4_to_mev4 = ħc^4
mev4_to_fm4 = fm4_to_mev4^(-1) 
mev4_to_mevfm3 = ħc^(-3)
mevfm3_to_mev4 = mev4_to_mevfm3^(-1)

ev_to_j = 1.602176634e-19
j_to_ev = ev_to_j^(-1)

mev4_to_jm3 = ((si_ħ*10^(-6))*si_c)^(-3) * (ev_to_j*10^6)
jm3_to_mev4 = mev4_to_jm3^(-1)
